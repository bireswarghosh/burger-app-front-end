...
function App() {
  ...
  return (
    <Router>
      <Header isAuthenticated={isAuthenticated} />  {/* by default nature isAuthenticated = flash show it on --> \src\components\layout\Header.jsx\8 & 27,29   if ir is true or directly    access isAuthenticated now only open  open  login page  */}
